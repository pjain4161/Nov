    ...
    return (
      <div>
        <Link
          ...
          style={{ color: "white", backgroundColor: "#015191", float: "right" }}
          className="gcButton"
        >
          Find New Benefits
        </Link>

        <h4 className="benefitsHeader gcPageHeader">Your Benefit Enrollments</h4>
        <h4 className="gcSubHeading gcLightText">Showing all benefits you are enrolled</h4>
        <FormGroup>
          <FormControl
            type="text"
